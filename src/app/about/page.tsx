  ...
  return (
    <div className="flex flex-col justify-center items-center gap-7 md:gap-10 min-h-[calc(100vh-2.5rem)] md:min-h-[calc(100vh-10rem)] w-full pt-20 md:pt-40 px-4 md:px-20">
      ...
      <div className="flex flex-col md:flex-row gap-10">
        ...
        <div className="flex flex-col gap-10">
          <div className="flex items-start gap-4">
            ...
            <div>
              <h3 className="text-xl font-semibold mb-1">Любовь к каждому питомцу</h3>
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              <h3 className="text-xl font-semibold mb-1">Индивидуальный подход</h3>
              <p className="text-gray-700">
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              <h3 className="text-xl font-semibold mb-1">Счастье наших клиентов</h3>
              <p className="text-gray-700">
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              <h3 className="text-xl font-semibold mb-1">Мы растём вместе с вами</h3>
              <p className="text-gray-700">
      ...
      <div className="flex flex-col justify-center items-center text-center max-w-[500px] mt-20">
        <p className="mb-4 text-gray-600 text-lg md:text-xl">
        ...
        <p className="mt-3 text-gray-500 text-sm md:text-base max-w-[300px]">
